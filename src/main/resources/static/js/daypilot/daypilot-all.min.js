      ...
      (DayPilot.Areas.showAreas = function (e, t, i, a, n) {
        ...
        (DayPilot.Switcher = function (e) {
          ...
          (this.f = []),
            ...
            (this.k = null),
            (this.l = DayPilot.Date.today()),
            (this.onChange = null),
            (this.onChanged = null),
            (this.onSelect = null),
            (this.j.updateMode = function (e) {
              var t = i.j.control;
            ...
            (this.show = function (e) {
              var a, n;
              if (e.A) (n = e), (a = n.C);
              else if (((a = e.m ? e : this.z(e)), this.k === a)) return;
              if (i.onSelect) {
                var o = {};
                (o.source = n ? n.B : null),
                  (o.target = a.control),
              ...
              i.j.updateMode(r),
                t(
                  i.j.control.selectionStart,
                  i.j.control.selectionEnd.addDays(1),
                  i.j.control.selectionDay
                );
            }),
            (this.z = function (e) {
              for (var t = 0; t < this.f.length; t++)
                if (this.f[t].control === e) return this.f[t];
              return null;
            }),
            (this.t = function () {
    ...
    if ("undefined" == typeof DayPilot.Calendar || !DayPilot.Calendar.events) {
      ...
      (t.selectedCells = []),
          ...
          if (t.resizing) {
            ...
            t.deleteShadow(t.movingShadow),
              DayPilot.Util.removeClass(
                t.moving,
                a.calendar.J("_event_moving_source")
              );
        ...
        (t.Calendar = function (e, i) {
          var a = !1;
          if (
            (this instanceof t.Calendar && !this.M && ((a = !0), (this.M = !0)),
            !a)
          )
          ...
          (this.uniqueID = null),
            ...
            (this.R = function (e, t, i) {
              ...
              var o = "JSON" + DayPilot.JSON.stringify(a);
              this.backendUrl
                ? DayPilot.request(this.backendUrl, this.S, o, this.ajaxError)
            ...
            (this.Z = function (e, t) {
              ...
              a.setAttribute("unselectable", "on"),
                ...
                (a.style.zIndex = 101),
                (a.className = n.J("_shadow"));
              var o = document.createElement("div");
              return (
                (o.className = n.J("_shadow_inner")),
                a.appendChild(o),
          ...
          (this.T = function (e, t) {
            ...
            (n.events.list = e.Events),
              n.ca(),
              n.da(),
              "Full" === e.UpdateType && (n.ea(), n.fa(), n.ga(), n.ha()),
              n.s(),
              n.ia(),
              n.clearSelection(),
            ...
            (this.ka = function () {
              ...
              return (
                (e =
                  "BusinessHoursNoScroll" === this.heightSpec ? this.la() : 24),
                60 * e * 60 * 1e3
              );
            }),
            (this.na = function () {
            ...
            (this.ya = {}),
            (this.ya.getCellCoords = function () {
              var e = {};
            ...
            (this.ba = function () {
              var e;
              (e = "Resources" !== n.viewType ? this.Aa() : n.columns.list),
                (this.ta = []);
            ...
            (this.Ca = function (e) {
              ...
              (o.style.position = "absolute"),
                ...
                (o.onclick = this.pa),
                DayPilot.re(o, "contextmenu", this.ra),
                ...
                (o.onmousedown = function (i) {
                  ...
                  if (
                    ...
                    if (1 === a && e.client.moveEnabled()) {
                      ...
                      (o.oldColumn = n.ta[this.data.part.dayIndex].id),
            ...
            (this.Ea = function () {
              (this.nav.top.innerHTML = ""),
                DayPilot.Util.addClass(this.nav.top, this.J("_main")),
                ...
                (this.nav.scroll.style.height = this.Fa() + "px"),
            ...
            (this.Ha = function () {
              ...
              return (
                ...
                i.appendChild(n),
                n.appendChild(this.Ja()),
                n.appendChild(this.Ka()),
                e.appendChild(t),
                (this.nav.zoom = e),
                e
              );
            ...
            (this.Ka = function () {
              ...
              (e.style.top = "0px"),
                ...
                (this.nav.events = e);
              for (
                var t = this.ta, i = t.length, a = e.insertRow(-1), o = 0;
                o < i;
                o++
              ) {
            ...
            (this.La = function (e, t) {
              ...
              var s = document.createElement("div");
              (s.style.position = "relative"),
                (s.className = this.J("_rowheader")),
                (s.style.width = this.hourWidth + "px"),
                (s.style.height = i + "px"),
                (s.style.overflow = "hidden"),
                (s.unselectable = "on");
              var l = document.createElement("div");
              (l.className = this.J("_rowheader_inner")),
                (l.unselectable = "on");
              var d = document.createElement("div");
              d.unselectable = "on";
              var c = this.startDate.addHours(t).addHours(n.na()),
                u = c.getHours(),
                h = u < 12,
                f = o.timeFormat();
              ...
              (m.unselectable = "on"),
                (m.className = this.J("_rowheader_minutes"));
              var p;
            ...
            (this.Ga = function () {
              ...
              if ((a.appendChild(this.nav.header), o)) {
                ...
                (r.unselectable = "on"),
                  ...
                  (r.className = this.J("_cornerright"));
                var s = document.createElement("div");
                (s.className = this.J("_cornerright_inner")),
                  r.appendChild(s),
                  a.appendChild(r),
            ...
            (this.Na = function () {
              ...
              return (
                (t.unselectable = "on"),
                (t.className = this.J("_corner_inner")),
                e.appendChild(t),
                e
              );
            }),
            ...
            (this.fa = function () {
              ...
              for (var f = 0; f < a; f++) {
                ...
                for (var d = 0; d < r; d++) {
                  ...
                  (u.unselectable = "on"),
                    ...
                    (u.style.position = "relative"),
                    (u.className = this.J("_cell"));
                  this.Oa(c.start, c.end) &&
                    DayPilot.Util.addClass(u, n.J("_cell_business"));
                  var p = document.createElement("div");
                  p.setAttribute("unselectable", "on"),
                    (p.className = this.J("_cell_inner")),
                    u.appendChild(p),
                    c.appendChild(u),
                    c.appendChild(u);
                }
              ...
              (e.root = this),
                (n.nav.scrollable.onmousemove = function (e) {
                  ...
                  if (t.resizing) {
                    t.resizingShadow ||
                      (t.resizingShadow = n.Z(t.resizing, !1, n.shadow));
                    var o = n.cellHeight,
                      r = 1,
                    ...
                    if (
                      (t.movingShadow ||
                        ((t.movingShadow = n.Z(t.moving, !n.O, n.shadow)),
            ...
            (this.Ua = function () {
              ...
              var t =
                "undefined" != typeof this.Wa.scrollpos
                  ? this.Wa.scrollpos
                  : this.initScrollPos;
              t &&
                ("Auto" === t &&
            ...
            (this.Za = function () {
              if (n.nav.top.className !== n.J("_main")) {
                ...
                var e = n.nav.corner;
                (e.className = n.J("_corner")),
                  (e.firstChild.className = n.J("_corner_inner"));
                var t = n.nav.cornerRight;
                t &&
                  ((t.className = n.J("_cornerright")),
                  (t.firstChild.className = n.J("_cornerright_inner")));
              }
            }),
            ...
            (this.lb = function () {
              (this.Wa.themes = []),
                this.Wa.themes.push(this.theme || this.cssClassPrefix);
            }),
            (this.mb = function () {
            ...
            (this.internal = {}),
            (this.internal.loadOptions = n.$a),
            (this.internal.xssTextHtml = n.Ra),
            (this.init = function () {
              this.db();
              var e = this.ib();
              return (
        ...
        (this.onShow = null),
          ...
          (this.prepare = function () {
            if (
              ...
              (this.resetTarget = !0),
              (this.pattern = this._.locale().datePattern),
      ...
      (t.mouse = null),
          ...
          (this.v = "2023.2.470-lite"),
            ...
            (this.show = function (i, o) {
              ...
              if (
                ...
                for (var u = 0; u < this.items.length; u++) {
                  ...
                  if (
                    (DayPilot.Util.addClass(f, this.vb("item")),
                    h.items &&
                      (DayPilot.Util.addClass(f, this.vb("item_haschildren")),
                      DayPilot.Util.addClass(d, this.vb("withchildren"))),
            ...
            (this.wb = function (e, t) {
              var i = e,
                n = t.source;
              if (
                (!a.ub.submenu || a.ub.submenu.item !== e) &&
                (a.ub.submenu &&
                  a.ub.submenu.item !== e &&
                  (DayPilot.Util.removeClass(
                    a.ub.submenu.link.parentNode,
                    a.vb("item_haschildren_active")
                  ),
                  a.ub.submenu.menu.hide(),
                  (a.ub.submenu = null)),
                e.items)
              ) {
                ...
                (o.items = e.items),
                  (a.ub.submenu = {}),
                  (a.ub.submenu.menu = new DayPilot.Menu(o)),
                  (a.ub.submenu.menu.xb = a),
                  a.ub.submenu.menu.show(n, {
                    submenu: !0,
                    parentLink: t,
                    parentItem: i,
                  }),
            ...
            (this.hide = function (e) {
              ...
              if (
                ...
                this.removeShadow(),
                this.ub.div &&
                  this.ub.div.parentNode === document.body &&
                  document.body.removeChild(this.ub.div),
                n && (DayPilot.de(n), (n = null)),
                (a.ub.visible = !1),
                (a.ub.source = null),
                a.xb && e.hideParent && a.xb.hide(e),
        ...
        (DayPilot.MenuBar.deactivate = function () {
          DayPilot.MenuBar.active &&
            (DayPilot.MenuBar.active.zb(), (DayPilot.MenuBar.active = null));
        }),
  ...
  (function (DayPilot) {
    ...
    if (!DayPilot.ModalStatic) {
      ...
      n.add(".modal_default_main", "border: 10px solid #ccc; max-width: 90%;"),
        ...
        (DayPilot.Modal = function (e) {
          ...
          (this.id = "_" + new Date().getTime() + "n" + 10 * Math.random()),
            ...
            (this.showUrl = function (e) {
              ...
              if (this.useIframe) {
                ...
                i &&
                  ...
                  this.re(this.iframe, "load", this.Jb),
                  (this.iframe.src = e),
                  this.Gb(),
                  this.Hb(),
                  this.Ib();
            ...
            (this.stretch = function () {
              ...
              if (this.useIframe) {
                ...
                this.autoStretchFirstLoadOnly &&
                  this.ue(this.iframe, "load", this.Jb);
            ...
            (this.Hb = function () {
              this.Cb ||
                (this.re(window, "resize", this.Qb),
                this.re(window, "scroll", this.Rb),
                this.dragDrop &&
                  (this.re(document, "mousemove", this.Sb),
                  this.re(document, "mouseup", this.Tb)),
                (this.Cb = !0));
            }),
            (this.Ub = function () {
              this.ue(window, "resize", this.Qb),
                this.ue(window, "scroll", this.Rb),
                this.dragDrop &&
                  (this.ue(document, "mousemove", this.Sb),
                  this.ue(document, "mouseup", this.Tb)),
                (this.Cb = !1);
            }),
            (this.Vb = function (e) {
              e.target === t.div &&
                ...
                t.Wb(),
                (t.Eb = t.mc(e || window.event)),
                (t.Db = { x: t.div.offsetLeft, y: t.div.offsetTop }));
            }),
            (this.Sb = function (e) {
              if (t.Eb) {
                var e = e || window.event,
                ...
                (t.div.style.marginLeft = "0px"),
                  (t.div.style.top = t.Db.y + n + "px"),
                  (t.div.style.left = t.Db.x + a + "px");
              }
            }),
            (this.Tb = function (e) {
            ...
            (this.Fb = function () {
              ...
              (o.id = this.id + "popup"),
                ...
                (o.style.width = "50px"),
                (o.style.height = "50px"),
                this.dragDrop && (o.onmousedown = this.Vb),
            ...
            (this.setInnerHTML = function (e, i) {
              ...
              n.document && (n = n.document),
                ...
                t.autoStretch &&
                  ((t.autoStretchFirstLoadOnly && t.$b) ||
                    (t.stretch(), (t.$b = !0)));
            }),
      ...
      (r.prototype.create = function () {
        ...
        (r.prototype.createView = function (e) {
          ...
          (o.onInput = function (e) {
            ...
            this.f.push(o),
            this.fc.appendChild(a);
        }),
        (r.prototype.validate = function () {
          var e = this,
            t = !0;
          return (
            this.f.forEach(function (i) {
              var a = e.gc(i);
              t = t && a;
            }),
            t
        ...
        (r.prototype.gc = function (e, t) {
          ...
          if (d) {
            ...
            if (c.valid)
              clearTimeout(this.ec[o.field]),
                e.hc && (e.hc.remove(), (e.hc = null)),
                e.fc.classList.remove(u);
            else if (!n)
              if (a) {
                var f = 1e3;
                clearTimeout(this.ec[o.field]),
                  (this.ec[o.field] = setTimeout(function () {
                    i();
                  }, f));
              } else i();
            r = c.valid;
        ...
        (r.prototype.updateState = function (e, t) {
          var i = this.dc ? this.dc : this.cc,
            a = i.indexOf(e);
          return (
            (this.dc = i.map(function (i) {
              if (i !== e) return i;
        ...
        d = function (e) {
          ...
          Object.defineProperty(this, "selected", {
            ...
            Object.defineProperty(this, "disabled", {
              ...
              set: function (e) {
                (this.lc = e),
                  this.qc && ((this.qc.disabled = e), e && this.tc());
              },
            });
      ...
      (d.prototype.select = function (e) {
        return (
          (this.nc = this.data.find(function (t) {
            return t.id === e;
          })),
          this.uc(!1),
          this
        ...
        (d.prototype.create = function () {
          ...
          function t(e) {
            ...
            document
              ...
              l.oc &&
                ((l.oc.className += " " + l.theme + "_list_item_highlight"),
                t && !i(l.oc, h) && l.oc.scrollIntoView());
          }
          function i(e, t) {
          ...
          return (
            ...
            (this.rc = h),
            this.nc ||
              ((this.nc = this.data[0]), this.nc && (m.value = this.nc.name)),
            c.appendChild(m),
            c.appendChild(u),
            c.appendChild(f),
            c.appendChild(h),
        ...
        (d.prototype.tc = function () {
          this.p(),
            this.nc
              ? (this.qc.value = this.nc.name)
              : ((this.qc.value = ""), this.uc(!0));
        }),
        (d.prototype.focus = function () {
          (this.pc = !0),
            this.qc.setAttribute("readonly", "readonly"),
            this.qc.focus(),
            this.tc();
        }),
        ...
        (d.prototype.uc = function (e) {
          if (
            ((this.sc.value = this.selected ? this.selected.id : null),
            this.nc ? (this.qc.value = this.nc.name) : (this.qc.value = ""),
    ...
    if ("undefined" == typeof DayPilot.Month || !DayPilot.Month.events) {
      ...
      (e.Month = function (t, i) {
        ...
        (this.id = t),
          ...
          (this.ca = function () {
            ...
            if (e) {
              ...
              if ("function" == typeof this.onBeforeEventRender)
                for (var t = 0; t < e.length; t++) this.fb(t);
          ...
          (this.Ca = function (t) {
            ...
            u.setAttribute("unselectable", "on"),
              ...
              (u.className = this.J("_event")),
              i.cssClass && DayPilot.Util.addClass(u, i.cssClass),
              t.part.startsHere ||
                DayPilot.Util.addClass(u, this.J("_event_continueleft")),
              t.part.endsHere ||
                DayPilot.Util.addClass(u, this.J("_event_continueright")),
              (u.event = t),
              (u.style.width = d + "%"),
              (u.style.position = "absolute"),
              (u.style.left = l + "%"),
            ...
            if (
              ...
              (h.className = this.J("_event_inner")),
              "darker" === i.borderColor && i.backColor
              ...
              f.setAttribute("unselectable", "on"),
                (f.className = this.J("_event_bar")),
                (f.style.position = "absolute");
              var m = document.createElement("div");
              m.setAttribute("unselectable", "on"),
                (m.className = this.J("_event_bar_inner")),
                (m.style.top = "0%"),
                (m.style.height = "100%"),
          ...
          (this.Kc = function () {
            ...
            for (var t = 0; t < this.getColCount(); t++) {
              ...
              o.setAttribute("unselectable", "on"),
                ...
                (o.style.left = "0px"),
                (o.style.right = "0px"),
                (o.className = this.J("_header_inner")),
                (o.innerHTML = n.locale().dayNames[a]),
                e.appendChild(i);
          ...
          (this.Nc = function (t, i, o) {
            ...
            c.setAttribute("unselectable", "on"),
              ...
              (c.style.top = "0px"),
              (c.style.bottom = "0px"),
              (c.className = this.J("_cell_inner")),
            ...
            u.setAttribute("unselectable", "on"),
              ...
              (u.className = this.J("_cell_header")),
          ...
          (this.R = function (e, t, i) {
            ...
            this.backendUrl &&
              DayPilot.request(this.backendUrl, this.S, n, this.ajaxError);
          }),
          (this.S = function (e) {
            a.T(e.responseText);
          }),
        ...
        (this.debug = function (e, t) {
          ...
          (this.internal = {}),
          (this.internal.loadOptions = this.$a),
          (this.internal.xssTextHtml = a.Ra),
          (this.init = function () {
            return (
              this.db(),
              this.loadFromServer()
    ...
    if ("undefined" == typeof DayPilot.Navigator || !DayPilot.Navigator.nav) {
      (DayPilot.Navigator = function (e, t) {
        ...
        (this.id = e),
          ...
          (this.Oc = function () {
            (this.root.dp = this),
              (this.root.className = this.J("_main")),
              "Horizontal" === this.orientation
                ? ((this.root.style.width =
                    this.showMonths * (7 * o.cellWidth() + this.Pc()) + "px"),
          ...
          (this.Kc = function (e, t) {
            ...
            (x.style.position = "absolute"),
              (x.style.left = 6 * o.cellWidth() + this.Pc() + "px"),
              (x.style.right = 6 * o.cellWidth() + this.Pc() + "px"),
              (x.style.top = "0px"),
              ...
              (x.className = this.J("_titleright")),
              t.right &&
            ...
            if (this.showWeekNumbers)
              for (var C = 0; C < h; C++) {
                ...
                (k.style.position = "absolute"),
                  ...
                  (k.className = this.J("_weeknumber")),
            ...
            for (var S = 0; S < 7; S++) {
              ...
              (k.style.position = "absolute"),
                ...
                k.setAttribute("unselectable", "on"),
                (k.className = this.J("_dayheader")),
                (k.innerHTML = "<span>" + this.Uc(S) + "</span>"),
                v.appendChild(k),
                a.days.push(k);
              for (var C = 0; C < h; C++) {
                var P = d.addDays(7 * C + S),
                  M = this.Vc(P) && "none" !== this.Wc(),
                  T = P.firstDayOfMonth() === n,
                  A = P < n,
                  H = P >= n.addMonths(1);
                if ("month" === this.Wc()) M = M && T;
                else if ("day" === this.Wc())
                  M = M && (T || (r && A) || (s && H));
                ...
                (N.day = P),
                  ...
                  (N.showBefore = r),
                  (N.showAfter = s),
                  (N.className = this.J(T ? "_day" : "_dayother")),
                  i.Qc(N, "cell"),
                  P.getTime() === f.getTime() && T && this.Qc(N, "today"),
                ...
                if (
                  ...
                  (j.innerHTML = P.getDay()),
                    ...
                    i.Qc(j, "cell_text"),
                    (N.isClickable = !0),
                    R && R.html && (j.innerHTML = R.html),
                    N.appendChild(j);
                }
                N.setAttribute("unselectable", "on"),
                  (N.onclick = this.Yc),
                  v.appendChild(N),
                  M && (i.Zc(v, S, C), this.selected.push(N));
              }
            }
            ...
            (B.style.position = "absolute"),
              (B.style.left = "0px"),
              (B.style.top = g - 2 + "px"),
              (B.style.width = 7 * o.cellWidth() + this.Pc() + "px"),
              (B.style.height = "1px"),
              (B.style.fontSize = "1px"),
              (B.style.lineHeight = "1px"),
              (B.className = this.J("_line")),
              v.appendChild(B),
              this.months.push(a);
          }),
                  ...
                  for (var i = 0; i < 6; i++) {
                    ...
                    a &&
                      (1 === this.items[a.day.toStringSortable()]
                        ? (this.Qc(a, "busy"), this.Rc(a, "free"))
                        : (this.Rc(a, "busy"), this.Qc(a, "free")));
                  }
          }),
          (this.ad = function () {
            var e = {};
          ...
          (this.select = function (e, t, a) {
            ...
            if (d) {
              ...
              (this.selectionStart < this.dd() ||
                this.selectionStart >= this.ed()) &&
          ...
          (this.R = function (e, t, i) {
            ...
            this.backendUrl
              ? DayPilot.request(this.backendUrl, this.S, n, this.kd)
              : WebForm_DoCallback(
                  this.uniqueID,
                  n,
                  this.T,
        ...
        (this.Yc = function (e) {
          ...
          (this.fd = function () {
            ...
            (this.root.style.height = this.td() + "px"),
        ...
        (o.locale = function () {
          ...
          (this.init = function () {
            if ((this.db(), !this.root.dp)) {
              this.bd(),
                ...
                this.Ya();
              if (
                (this.vd() && this.gd(), (this.za = !0), this.cb(), this.cd)
              ) {
                var e = this.cd;
          ...
          (this.xd = function () {
            (i.nav.top.onmousedown = this.od),
              (i.nav.top.onmousemove = this.pd);
          }),
          (this.Ya = function () {
